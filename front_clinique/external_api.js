    ...
    (() => {
        var t = {
                ...
                7054: (t, e, r) => {
                    ...
                    function i(t, e) {
                        (this.logStorage = t),
                            (this.stringifyObjects =
                                !(!e || !e.stringifyObjects) &&
                                e.stringifyObjects),
                            (this.storeInterval =
                                e && e.storeInterval ? e.storeInterval : 3e4),
                            (this.maxEntryLength =
                                e && e.maxEntryLength ? e.maxEntryLength : 1e4),
                            Object.values(n.levels).forEach(
                                function (t) {
                                    this[t] = function () {
                    ...
                    (i.prototype.stringify = function (t) {
                        ...
                        (i.prototype._log = function () {
                            ...
                            this.totalLen >= this.maxEntryLength &&
                                this._flush(!0, !0);
                        }),
                ...
                939: (t, e, r) => {
                    ...
                    function f(t) {
                        ...
                        if (r) {
                            ...
                            "http:" !== n && "https:" !== n && (n = "https:"),
                                (t = t.substring(e.lastIndex)).startsWith(
                                    "//"
                                ) && (t = n + t);
                        }
                        return t;
                    ...
                    class x {
                        ...
                        _onMessageReceived(t) {
                            if (t.type === w) {
                                ...
                                e &&
                                    (e(t), this._responseHandlers.delete(t.id));
                            } else
                                t.type === b
                        ...
                        on(t, e) {
                            ...
                            return (
                                ...
                                this._unprocessedMessages.forEach((t) => {
                                    e(...t) &&
                                        this._unprocessedMessages.delete(t);
                                }),
                                this
                            );
                        }
                        ...
                        sendEvent(t = {}) {
                            this._backend &&
                                this._backend.send({ type: "event", data: t });
                        }
                        sendRequest(t) {
                            if (!this._backend)
                                ...
                                o.forEach((t) => {
                                    ...
                                    try {
                                        ...
                                        return void (function (t) {
                                            ...
                                            t,
                                            `Failed to parse URL parameter value: ${String(
                                                o
                                            )}`
                                        );
                                    }
                    ...
                    const S = r
                        .n(E)()
                        .getLogger("modules/API/external/functions.js");
                    function O(t, e) {
                    ...
                    const R = ["css/all.css", "libs/alwaysontop.min.js"],
                        A = {
                            ...
                            sendCameraFacingMode:
                                "send-camera-facing-mode-message",
                        ...
                        L = {
                            ...
                            "participant-menu-button-clicked":
                    ...
                    class T extends i() {
                        constructor(t) {
                            ...
                            (this._parentNode = o),
                                ...
                                (this._transport = new x({
                                    backend: new m({
                                        postisOptions: {
                                            allowedOrigin: new URL(this._url)
                                                .origin,
                        ...
                        _getLargeVideo() {
                            ...
                            if (
                                ...
                                return t.contentWindow.document.getElementById(
                                    "largeVideo"
                                );
                        }
                        _getPrejoinVideo() {
                        ...
                        _setSize(t, e) {
                            ...
                            void 0 !== r &&
                                ((this._height = t),
                                (this._frame.style.height = r)),
                                void 0 !== n &&
                                    ((this._width = e),
                                    (this._frame.style.width = n));
                        }
                        _setupListeners() {
                            this._transport.on("event", (t) => {
                                ...
                                switch (e) {
                                    ...
                                    case "participant-joined":
                                        (this._participants[n] =
                                            this._participants[n] || {}),
                                            (this._participants[n].displayName =
                                                r.displayName),
                                            (this._participants[
                                                n
                        ...
                        dispose() {
                            this.emit("_willDispose"),
                                ...
                                this._frame &&
                                    ...
                                    this._frame.parentNode.removeChild(
                                        this._frame
                                    );
                        }
                        executeCommand(t) {
                        ...
                        async setMediaEncryptionKey(t) {
                            ...
                            if (e) {
                                const t = await crypto.subtle.exportKey(
                                    "raw",
                                    e
                                );
                                this.executeCommand(
                ...
                6469: (t, e, r) => {
                    ...
                    var n = r(8227),
                        ...
                        a = Array.prototype;
                    void 0 === a[s] &&
                        o(a, s, { configurable: !0, value: i(null) }),
                        (t.exports = function (t) {
                            a[s][t] = !0;
                        });
                },
                ...
                4644: (t, e, r) => {
                    ...
                    t.exports = {
                        ...
                        aTypedArrayConstructor: function (t) {
                            ...
                            throw new j(
                                d(t) + " is not a typed array constructor"
                            );
                        },
                ...
                6706: (t, e, r) => {
                    ...
                    t.exports = function (t, e, r) {
                        try {
                            return n(
                                i(Object.getOwnPropertyDescriptor(t, e)[r])
                            );
                        } catch (t) {}
                    };
                },
                    ...
                    (b && w) ||
                        ...
                        m
                            ...
                            : a.addEventListener &&
                              ...
                              "file:" !== n.protocol &&
                              !f(j)
                            ? ((i = j), a.addEventListener("message", I, !1))
                            : (i =
                                  L in v("script")
                                      ? function (t) {
                                            d.appendChild(v("script"))[L] =
                                                function () {
                ...
                4601: (t, e, r) => {
                    ...
                    t.exports = function (t, e, r, g) {
                        ...
                        if (x) {
                            var _ = x.prototype;
                            if ((!v && i(_, "cause") && delete _.cause, !r))
                                return x;
                            var E = n("Error"),
                                S = e(function (t, e) {
                ...
                8111: (t, e, r) => {
                    ...
                    f(h, b) || S(b, m),
                        ...
                        (E.prototype = h),
                        n(
                            { global: !0, constructor: !0, forced: _ },
                            { Iterator: E }
                        );
                },
                7588: (t, e, r) => {
                        ...
                        G = function (t, e, r) {
                            ...
                            $
                                ...
                                !I && (i = u["on" + t])
                                    ? i(n)
                                    : t === W &&
                                      _("Unhandled promise rejection", r);
                        },
                        H = function (t) {
                            p(w, u, function () {
                                var e,
