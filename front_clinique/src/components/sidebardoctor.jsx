...
import {
    ...
    ClipboardList,   // Remplacé de FaFilePrescription pour Ordonnances et Consultations
    Video,           // Remplacé de FaVideo
    Pill,
    Bell,        // Remplacé de FaCapsules pour Dossiers des patients
    User,            // Remplacé de FaUser
    LogOut,          // Remplacé de FaSignOutAlt
    MessageSquare,   // Nouvelle icône pour Messages
    FileText         // Nouvelle icône pour Messages personnels de santé
...
const fetchUserData = async () => {
    ...
    return (
        <div className="sidebar-doctor">
            <div className="sidebar-doctor-header">
                <h2><Shield className="login-icon"/>GISS</h2>
            </div>
            <ul className="sidebar-doctor-menu">
                <li>
                    <NavLink to="/dashboard/docteur" className={({ isActive }) => isActive ? "active" : ""}>
                        <LayoutDashboard className="icon" /> Tableau de bord
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/docteur/rendez-vous" className={({ isActive }) => isActive ? "active" : ""}>
                        <CalendarCheck className="icon" /> Rendez-vous
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/docteur/prescription" className={({ isActive }) => isActive ? "active" : ""}>
                        <ClipboardList className="icon" /> Ordonnances
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/doctor/online-consultations" className={({ isActive }) => isActive ? "active" : ""}>
                        <Video className="icon" /> Consultations
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/emplois-du-Temps" className={({ isActive }) => isActive ? "active" : ""}>
                        <ClipboardList className="icon" /> Emplois du temps
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/message-docteur" className={({ isActive }) => isActive ? "active" : ""}>
                        <MessageSquare className="icon" /> Messages
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/dossier-patient-docteur" className={({ isActive }) => isActive ? "active" : ""}>
                        <Pill className="icon" /> Dossiers des patients
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/docteur-notification" className={({ isActive }) => isActive ? "active" : ""}>
