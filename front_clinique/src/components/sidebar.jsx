    ...
    return (
        <div className="sidebar-doctor"> {/* Modification ici */}
            ...
            <ul className="sidebar-doctor-menu">
                ...
                <li>
                    <NavLink to="/appointments" className={({ isActive }) => isActive ? "active" : ""}><CalendarCheck className="icon" /> Rendez-vous</NavLink>
                </li>
                <li>
                    <NavLink to="/patient/prescription" className={({ isActive }) => isActive ? "active" : ""}><ClipboardList className="icon" /> Ordonnances</NavLink>
                </li>
                <li>
                    <NavLink to="/pharmacie" className={({ isActive }) => isActive ? "active" : ""}><Building2 className="icon" /> Pharmacies</NavLink>
                </li>
                <li>
                    <NavLink to="/message-patient" className={({ isActive }) => isActive ? "active" : ""}><MessageSquare className="icon" /> Messages</NavLink>
                </li>
                <li>
                    <NavLink to="/patient/online-consultations" className={({ isActive }) => isActive ? "active" : ""}><Video className="icon" /> Consultations</NavLink>
                </li>
                <li>
                    <NavLink to="/patient-service" className={({ isActive }) => isActive ? "active" : ""}><Stethoscope className="icon" /> Services</NavLink>
                </li>
                <li>
                    <NavLink to="/service" className={({ isActive }) => isActive ? "active" : ""}><Stethoscope className="icon" /> Demandes de service</NavLink>
                </li>
                <li>
                ...
                <li>
                    <NavLink to="/profil" className={({ isActive }) => isActive ? "active" : ""}><User className="icon" /> Profil</NavLink>
                </li>
            </ul>
