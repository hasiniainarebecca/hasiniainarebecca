...
import { Bell, Calendar, FileText, Video, User, Package, MessageSquare, PlusCircle, CheckCircle, XCircle, RefreshCw, MinusCircle, AlertTriangle, Edit, Trash2 } from 'lucide-react'; // Importer les nouvelles icônes
import axios from 'axios';
import "./styles/NotificationsPage.css";
import { useUnreadCount } from './contexts/UnreadCountContext';

const NotificationsInfirmierPage = () => {
...
const NotificationItem = ({ notification, onMarkAsRead }) => {
  const {
    ...
    // NOUVEAU: pour les notifications de matériel
    materiel_name,
    quantity_change,
    current_stock,
    min_stock,
  ...
  const getIcon = () => {
    switch(type) {
      ...
      case 'materiel_event': // NOUVEAU: pour les notifications de matériel
        switch(event_type) {
  ...
  if (type === 'rendez_vous') {
    ...
    titreNotification = notification.data.title;
  } else if (type === 'materiel_event') { // NOUVEAU: pour les notifications de matériel
...
export default NotificationsInfirmierPage;
