...
import { Bell, Calendar, FileText, Video, User, Package, MessageSquare, PlusCircle, CheckCircle, XCircle } from 'lucide-react'; // Importer les nouvelles icônes
import axios from 'axios';
import "./styles/NotificationsPage.css";
import { useUnreadCount } from './contexts/UnreadCountContext';

const NotificationsPatientsPage = () => {
...
const NotificationItem = ({ notification, onMarkAsRead }) => {
  const {
    ...
    doctor_name,
    patient_name,
    event_type, // Nouveau: pour les notifications de service
    notifier_name, // Nouveau: pour les notifications de service (qui a déclenché)
  } = notification.data;
  ...
  const getIcon = () => {
    switch(type) {
      ...
      case 'service_event': // Nouveau type pour les événements de service
        switch(event_type) {
  ...
  if (type === 'rendez_vous') {
    if (statut_rendez_vous === 'accepte') {
      titreNotification = `Rendez-vous accepté`;
    } else if (statut_rendez_vous === 'refuse') {
      titreNotification = `Rendez-vous refusé`;
    } else if (statut_rendez_vous === 'rappel') {
      titreNotification = `Rappel de rendez-vous`;
    } else if (statut_rendez_vous === 'reserve') {
  ...
  } else if (type === 'service_event') { // Nouveau: pour les notifications de service
...
export default NotificationsPatientsPage;
